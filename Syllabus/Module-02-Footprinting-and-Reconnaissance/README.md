...
| E | [`05-whois-and-dns-footprinting.md`](05-whois-ip-geolocation-and-dns-footprinting.md) | Whois lookup (3 data models, 5 RIRs), Whois tools, IP geolocation, DNS record types, DNS interrogation tools (SecurityTrails, Fierce), AI-assisted DNS lookup, and reverse DNS lookup |
...
| H | [`08-footprinting-tools-and-ai-automation.md`](08-footprinting-tools-and-ai-powered-automation.md) | Maltego, Recon-ng, FOCA, subfinder, OSINT Framework, Recon-Dog, BillCipher, and 12+ AI-powered OSINT tools, plus AI-generated custom footprinting scripts |
| I | [`09-footprinting-countermeasures-and-summary.md`](09-footprinting-countermeasures-and-module-summary.md) | The full footprinting countermeasures checklist, organized by category, plus the module summary |
