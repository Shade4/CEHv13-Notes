...
| 3 | [`03-network-fundamentals-part1.md`](03-computer-network-fundamentals-part1.md) | OSI & TCP/IP models, 6 network types, wireless standards/technologies, 6 topologies, hardware components, LAN technology, cabling |
